{
  ...
  inputs = {
    ...
    base1.url        = github:sixears/base1/r0.0.9.26;
    parsec-plus.url  = github:sixears/parsec-plus/r1.1.1.24;
    parser-plus.url  = github:sixears/parser-plus/r1.0.7.18;
    textual-plus.url = github:sixears/textual-plus/r1.0.2.20;
  };
